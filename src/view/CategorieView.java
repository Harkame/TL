...
public class CategorieView extends JPanel implements Observer
{
	...
	public CategorieView()
	{
		...
		JList jlist_taches = new JList(liste_tache_simple.toArray());
	...
	{
		/*
		 * if(arg0 == taches) jlist_taches = new JList(taches.toArray());
		 */
	}
}